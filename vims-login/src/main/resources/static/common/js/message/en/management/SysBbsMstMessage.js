...
//Message.Label = {};
//Message.Label.Array = {};
Message.Label.Array["SYS_BBS_MST.TITLE_DETAIL"] = "Board Master Details";
Message.Label.Array["SYS_BBS_MST.TITLE_LIST"] = "Board Master List";
Message.Label.Array["SYS_BBS_MST.TITLE_UPDATE"] = "Edit Board Master";
Message.Label.Array["SYS_BBS_MST.TITLE_REGISTER"] = "Register Board Master";

Message.Label.Array["SYS_BBS_MST.SUB_TITLE_DETAIL"] = "Detailed information on the board master";
Message.Label.Array["SYS_BBS_MST.SUB_TITLE_LIST"] = "Guide to the board master list";
Message.Label.Array["SYS_BBS_MST.SUB_TITLE_UPDATE"] = "Guide to editing board master information";
Message.Label.Array["SYS_BBS_MST.SUB_TITLE_REGISTER"] = "Guide to registering board master information";

Message.Label.Array["SYS_BBS_MST.INFO"] = "Board master basic information";
